...
insert into agenda(apellido, nombre, domicilio, telefono)
	values('Garcia', 'Emill', 'Calle C', '8094341241')
insert into agenda(apellido, nombre, domicilio, telefono)
	values('Perez', 'Juan', 'Colon 532', '8094642344')
...
select documento, domicilio, sueldobasico from empleados;
...
insert into agenda (apellido, nombre, domicilio, telefono)
  values ('Lopez','Luis','Urquiza','4545454');
insert into agenda (apellido, nombre, domicilio, telefono)
  values ('Lopez','Marisa','Urquiza ','4545454');
...
insert into agenda(apellido, nombre, domicilio, telefono)
	values('Alvarez','Juan', 'Avellaneda 135','4545454');
insert into agenda(apellido, nombre, domicilio, telefono)
...
go
insert into peliculas (codigo,titulo,actor,duracion)
  values(null,'Mujer bonita','R. Gere-J. Roberts',190); --error-
go
...
go
 ...
 insert into alumnos (documento,nombre,domicilio)
  values('25666777','Torres Ramiro','Dinamarca 209');
 select * from alumnos;
--El ejercicio 2 es lo mismo, por ende lo omitire.--
--16 - Otros tipos de datos en SQL Server--
	--No contiene problemas--
